...
CY_ISR(SCB_2_I2C_ISR)
{
    ...
    */
    ...
    {
        SCB_2_CTRL_REG &= (uint32) ~SCB_2_CTRL_ENABLED; /* Disable scb IP */

        SCB_2_state = SCB_2_I2C_FSM_IDLE;

        SCB_2_DISABLE_SLAVE_AUTO_DATA;
        SCB_2_DISABLE_MASTER_AUTO_DATA;
        ...
        SCB_2_ClearTxInterruptSource(SCB_2_INTR_RX_ALL);
        SCB_2_ClearRxInterruptSource(SCB_2_INTR_TX_ALL);
        SCB_2_ClearSlaveInterruptSource(SCB_2_INTR_SLAVE_ALL);
        SCB_2_ClearMasterInterruptSource(SCB_2_INTR_MASTER_ALL);
    #endif /* (SCB_2_CY_SCBIP_V0) */

        SCB_2_CTRL_REG |= (uint32) SCB_2_CTRL_ENABLED;  /* Enable scb IP */
    }
